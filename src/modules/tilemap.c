...
Vec2_Int tilemap_collision(const Vec2_Int *movement, const Box_Collider *col, const Tilemap *tile_map)
{
    ...
    {
        col_grid_pos1.x = (col->transform.x + modified_movement.x) / tile_map->tileset->tile_width;
        col_grid_pos2.x = (col->transform.x + modified_movement.x + col->w) / tile_map->tileset->tile_width;
        col_grid_pos1.y = (col->transform.y + modified_movement.y) / tile_map->tileset->tile_height;
        col_grid_pos2.y = (col->transform.y + modified_movement.y + col->h) / tile_map->tileset->tile_height;
